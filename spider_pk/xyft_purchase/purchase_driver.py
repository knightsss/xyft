...
pk_logger = PkLog('xyft_purchase.purchase_driver').log()
...
def get_driver(username,password):
    ...
    #xyft
    pk10 = driver.find_element_by_xpath('//*[@id="l_XYFT"]/span')
    pk10.click()
    time.sleep(1)

    # 1-10
    element_1_10 = driver.find_element_by_xpath('//*[@id="sub_XYFT"]/a[2]')
    element_1_10.click()
    time.sleep(1)
