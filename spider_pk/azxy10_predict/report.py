...
import time
from azxy10_predict.models import KillPredictTotal
from azxy10_predict.models import KillPredict
from azxy10_predict.models import PredictLottery
import datetime
from azxy10_predict.spider_pk10 import get_html_result,get_lottery_id_number,load_lottery_predict
from azxy10_predict.main import calculate_percisoin


from pkten_log.pk_log import PkLog

pk_logger = PkLog('azxy10_predict.report').log()
...
def predict_report(request):
    ...
    return render_to_response('azxy10_predict_list.html',{"obj_pro_predict":obj_pro_predict})
...
def control_predict_report(request):
    ...
    #遍历所有当天对象
    obj_pro_predict = KillPredict.objects.filter(kill_predict_date=in_date).filter(is_xiazhu=1)
    base_hour = 8
    ...
    return render_to_response('azxy10_predict_list.html',{"obj_pro_predict":obj_pro_predict, "obj_pro_predict_total":obj_pro_predict_total,  "p_date":in_date})
