...
from azxy10_predict.models import KillPredict,PredictLottery
from azxy10_predict.thread import ThreadControl
import math

from azxy10_predict.predict_next_purchase_number import spider_predict_selenium,get_purchase_list
...
pk_logger = PkLog('azxy10_predict.main').log()
...
def predict_main(request):
    ...
    for prob_user in prob_user_list:
        ...
        try:
            ...
            prob_user.user_status = 0
            prob_user.save()
    return render_to_response('azxy10_predict_main.html',{"prob_user_list":prob_user_list})
...
def control_predict_thread(request):
    ...
    prob_user_list =  ProbUser.objects.all()
    return render_to_response('azxy10_predict_main.html',{"prob_user_list":prob_user_list,"p_rule":request.POST['in_rule']})
