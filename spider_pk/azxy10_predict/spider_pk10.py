...
pk_logger = PkLog('azxy10_predict.spider_pk10').log()
...
def get_html_result():
    ...
    while(flag):
        try :
            ...
            #url = "https://api.api861861.com/pks/getPksHistoryList.do?date=" + current_date + "&lotCode=10057"
            url = "https://api.api861861.com/pks/getPksHistoryList.do?date=" + current_date + "&lotCode=10012"
...
def load_lottery_predict(html_json):
    ...
    for i in range(len(html_json['result']['data'])):
        ...
        p = PredictLottery(lottery_month=lottery_month, lottery_date=lottery_date, lottery_time=lottery_time,
