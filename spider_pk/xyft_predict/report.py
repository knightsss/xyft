...
import time
from xyft_predict.models import KillPredictTotal
...
from xyft_predict.main import calculate_percisoin


from pkten_log.pk_log import PkLog

pk_logger = PkLog('xyft_predict.report').log()
...
def predict_report(request):
    ...
    return render_to_response('xyft_predict_list.html',{"obj_pro_predict":obj_pro_predict})
...
def control_predict_report(request):
    ...
    return render_to_response('xyft_predict_list.html',{"obj_pro_predict":obj_pro_predict, "obj_pro_predict_total":obj_pro_predict_total,  "p_date":in_date})
