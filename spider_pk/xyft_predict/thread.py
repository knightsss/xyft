...
pk_logger = PkLog('xyft_predict.thread').log()
...
def loaddata(c_thread,thread_num,interval):
    ...
    while not c_thread.thread_stop:
        ...
        if flag_date > '13:00:00' or flag_date < "04:04:59":
            ...
            if current_minute<5 and last_minute> 0:
                last_minute = -2
            if current_minute - last_minute > 3 or current_minute < 2:
                ...
                if judge_num < 2:
                    ...
                    xyft_predict.main.spider_save_predict(interval)
