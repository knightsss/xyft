...
pk_logger = PkLog('xyft_purchase_wow.client_thread').log()
...
def loaddata(c_thread,thread_num,interval):
    ...
    while not c_thread.thread_stop:
        ...
        if flag_date > '13:05:00' or flag_date < "04:04:59":
        # print "current_minute ",current_minute
            ...
            if current_minute - last_minute > 3:
                ...
                if judge_num<2 :
                    ...
                    pk_logger.info("开始购买")
                    xyft_purchase_wow.purchase_client_main.get_predict_kill_and_save(interval)
