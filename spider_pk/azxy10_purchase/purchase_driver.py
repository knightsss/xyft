...
pk_logger = PkLog('azxy10_purchase.purchase_driver').log()
...
def get_driver(username,password):
    ...
    #driver.get("https://5069725987-ccgj.qq168.ws/login")
    driver.get("https://5069725987-ccgj.qq168.ws/login")
    #driver.get("https://42862201-ccgj.qq168.ws/login")
    ...
    try:
        driver.find_element_by_xpath('//*[@id="notice_button5"]/a').click()
        time.sleep(1)
    except:
        pk_logger.warn("unfound button5")

    #azxy10
    pk10 = driver.find_element_by_xpath('//*[@id="l_AULUCKY10"]/span')
    pk10.click()
    time.sleep(1)

    # 1-10
    element_1_10 = driver.find_element_by_xpath('//*[@id="sub_AULUCKY10"]/a[2]')
    element_1_10.click()
    time.sleep(1)
