...
pk_logger = PkLog('xyft_purchase_jinsha.purchase_driver').log()
#'//*[@id="username"]'
...
def get_driver(username,password):
    ...
    #xyft
    try:
        xyft = driver.find_element_by_id('countdown_lt_320')
        xyft.click()
        time.sleep(2)
    except:
        pk_logger.error("not found xyft link!")
